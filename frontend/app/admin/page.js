  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const [patientsRes, doctorsRes, appointmentsRes, applicationsRes] = await Promise.all([
        fetch('http://localhost:9000/api/patients/stats'),
        fetch('http://localhost:9000/api/doctors/stats'),
        fetch('http://localhost:9000/api/appointments/stats'),
        fetch('http://localhost:9000/api/applications/stats')
      ]);
      ...
      const appointmentsRes2 = await fetch('http://localhost:9000/api/appointments?limit=5&status=pending');
