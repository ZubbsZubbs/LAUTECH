...
const OurServices = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-gray-50 to-blue-100 relative overflow-hidden">
      ...
      {/* Hero Section */}
      <div className="relative w-full bg-black text-white text-center pt-32 pb-20">
      ...
      >
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={service.id}
              className={`relative group bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl min-h-[400px] flex flex-col opacity-0 animate-slide-in-left`}
              style={{
            ...
            >
              {/* Service Icon */}
              <div className="relative p-4 h-[75%]">
              ...
              {/* Service Text */}
              <div className="h-[25%] flex flex-col justify-center p-4">
