...
export const sendUnderReviewEmail = async (application: any) => {
...
export const sendRejectionEmail = async (application: any) => {
...
export const sendWaitlistEmail = async (application: any) => {
...
export const sendApplicationStatusEmail = async (application: any) => {
  try {
    switch (application.status) {
      case ApplicationStatus.UNDER_REVIEW:
        await sendUnderReviewEmail(application);
        break;
