...
import Settings, { ISettings, IProfileSettings, IHospitalSettings, INotificationSettings, ISecuritySettings, ISystemSettings } from '../models/Settings';
...
export const updateProfileSettings = async (req: Request, res: Response): Promise<void> => {
  try {
    const { userId } = req.params;
    const profileData: IProfileSettings = req.body;
...
export const updateHospitalSettings = async (req: Request, res: Response): Promise<void> => {
  try {
    const { userId } = req.params;
    const hospitalData: IHospitalSettings = req.body;
...
export const updateNotificationSettings = async (req: Request, res: Response): Promise<void> => {
  try {
    const { userId } = req.params;
    const notificationData: INotificationSettings = req.body;
...
export const updateSecuritySettings = async (req: Request, res: Response): Promise<void> => {
  try {
    const { userId } = req.params;
    const securityData: ISecuritySettings = req.body;
...
export const updateSystemSettings = async (req: Request, res: Response): Promise<void> => {
  try {
    const { userId } = req.params;
    const systemData: ISystemSettings = req.body;
